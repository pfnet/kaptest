...
func simpleMutatingPolicyAndBinding() (*v1.MutatingAdmissionPolicy, *v1.MutatingAdmissionPolicyBinding) {
	mut := &v1.MutatingAdmissionPolicy{
		ObjectMeta: metav1.ObjectMeta{
			Name: "simplePolicy",
		},
		Spec: v1.MutatingAdmissionPolicySpec{
			FailurePolicy:      ptr.To(v1.Fail),
			ReinvocationPolicy: v1.IfNeededReinvocationPolicy,
	...
	mut.GetObjectKind().SetGroupVersionKind(v1.SchemeGroupVersion.WithKind("MutatingAdmissionPolicy"))
	...
	binding.GetObjectKind().SetGroupVersionKind(v1.SchemeGroupVersion.WithKind("MutatingAdmissionPolicyBinding"))
...
func TestMutator_Mutate_SimplePolicy_WithParam(t *testing.T) {
	...
	policy, _ := simpleMutatingPolicyAndBinding()
	policy.Spec.ParamKind = &v1.ParamKind{
		APIVersion: "v1",
		Kind:       "ConfigMap",
	}
	policy.Spec.Mutations = []v1.Mutation{
